...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(jQuery) {/* Chosen v1.6.2 | (c) 2011-2016 by Harvest | MIT License, https://github.com/harvesthq/chosen/blob/master/LICENSE.md */
	(function () {
	  var a,
	      AbstractChosen,
	      Chosen,
	    ...
	    function AbstractChosen(a, b) {
	      ...
	      var b, c;switch (b = null != (c = a.which) ? c : a.keyCode, this.search_field_scale(), b) {case 8:
	          ...
	          return this.results_showing && this.results_hide(), !0;case 9:case 38:case 40:case 16:case 91:case 17:case 18:
	          break;default:
	    ...
	    }, AbstractChosen.default_multiple_text = "V�lj kategori", AbstractChosen.default_single_text = "Select an Option", AbstractChosen.default_no_result_text = "No results match", AbstractChosen;
	  }(), a = jQuery, a.fn.extend({ chosen: function (b) {
	      return AbstractChosen.browser_is_supported() ? this.each(function (c) {
	        var d, e;return d = a(this), e = d.data("chosen"), "destroy" === b ? void (e instanceof Chosen && e.destroy()) : void (e instanceof Chosen || d.data("chosen", new Chosen(this, b)));
	      }) : this;
	    } }), Chosen = function (c) {
	    function Chosen() {
