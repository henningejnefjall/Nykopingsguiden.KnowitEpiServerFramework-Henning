...
define([
    ...
    "googlemaps/Async!https://maps.googleapis.com/maps/api/js?v=3.exp&libraries=places&key=AIzaSyD064RF-cBHfhvB_UFMO8xbCAsRVpv2k5w" // Use async module to load external asyncronously loaded script for Google Maps
],
function (connect,declare,aspect,registry,WidgetSet,_Widget,_TemplatedMixin,_WidgetsInTemplateMixin,epi,_ValueRequiredMixin,localized
) {
    return declare("googlemaps.editor", [_Widget, _TemplatedMixin, _WidgetsInTemplateMixin, _ValueRequiredMixin], {
        ...
        templateString: dojo.cache("googlemaps.editor", "WidgetTemplate.html"),
